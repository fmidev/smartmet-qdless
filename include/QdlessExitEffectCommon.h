...
// Kenney's "Platformer Art Deluxe" pack (https://kenney.nl/assets — CC0).
// Modern 2014-era cartoon platformer sprites: clean PNGs, alpha-keyed,
// ~50-100 px tall, with multi-frame animation cycles (walk has 11 frames,
// most others 2 frames). Loaded from data/kenney/<motion>/frame_NN.png
// prepared by scripts/kenney2sprites.py. The struct is the same as
// MuybridgeMotion's — just frames + sizes — but kept separate so the
// list of motion names doesn't collide with Muybridge's.
constexpr const char* kKenneyMotions[] = {
    // Row 0: human player. The walk cycle (11 frames) is the showpiece.
    "walk",
    "jump",
    "duck",
    "hurt",
    // Row 1: an alien sci-fi character, four 1-2 frame cycles.
    "alien_walk",
    "alien_climb",
    "alien_swim",
    "alien_jump",
    ...
    "spider",
    "fish",
    // Row 3: air-borne creatures + a three-character party shot.
    "fly",
    "bee",
    "bat",
    "trio",
};
constexpr int kKenneyMotionCount =
    static_cast<int>(sizeof(kKenneyMotions) / sizeof(kKenneyMotions[0]));

constexpr const char* kKenneyLabels[kKenneyMotionCount] = {
    "Walk",
    "Jump",
    "Duck",
    "Ouch",
...
inline MuybridgeMotion loadKenneyMotion(const char* name)
{
  MuybridgeMotion m;
  m.name = name;
  for (int i = 0; i < 32; ++i)
  {
    char rel[128];
    std::snprintf(rel, sizeof(rel), "kenney/%s/frame_%02d.png", name, i);
    std::size_t fw = 0, fh = 0;
    auto img = loadDataImage(rel, fw, fh);
    if (!img)
      break;
...
inline std::vector<MuybridgeMotion> loadAllKenneyMotions()
{
  std::vector<MuybridgeMotion> out;
  out.reserve(kKenneyMotionCount);
  for (int i = 0; i < kKenneyMotionCount; ++i)
    out.push_back(loadKenneyMotion(kKenneyMotions[i]));
  return out;
}

// Composite a Kenney sprite preserving its original (cartoon) colour.
// Unlike drawMuybridgeFrame which tints to a single colour for the
// silhouette style, Kenney's art is fully coloured and we want to keep
// it that way over the dimmed data backdrop.
inline void drawKenneyFrame(std::vector<Rgb>& dst, int w, int h, float ya,
                            const MuybridgeMotion& m, int frameIdx,
                            float cx, float cy, float spriteH)
{
  if (m.frames.empty())
    return;
  const int n = static_cast<int>(m.frames.size());
  const int idx = ((frameIdx % n) + n) % n;
  const auto& img = m.frames[idx];
  const auto [iw, ih] = m.sizes[idx];
  if (img == nullptr || iw == 0 || ih == 0)
    return;
...
constexpr int kEffectCount = 328;
...
constexpr Theme kThemes[kEffectCount] = {
    ...
    /* 141 Kenney                 */ Theme::Cartoon,
    /* 142 King Kong              */ Theme::Cinema,
    /* 143 Koyaanisqatsi          */ Theme::Cinema,
    /* 144 Krakatoa               */ Theme::Weather,
    /* 145 Lagrange Points        */ Theme::Physics,
    /* 146 Lava Lamp              */ Theme::Chemistry,
    /* 147 Lawrence               */ Theme::Cinema,
    /* 148 Lebowski               */ Theme::Cinema,
    /* 149 Liberty Torch          */ Theme::History,
    /* 150 Liesegang              */ Theme::Chemistry,
    /* 151 LIGO Chirp             */ Theme::Physics,
    /* 152 Lorenz Attractor       */ Theme::Physics,
    /* 153 Lucy                   */ Theme::Biology,
    /* 154 Lunar Eclipse          */ Theme::Physics,
    /* 155 Macarena               */ Theme::Music,
    /* 156 Magna Carta            */ Theme::History,
    /* 157 Magnetar               */ Theme::Physics,
    /* 158 Magnetosphere          */ Theme::Physics,
    /* 159 Magritte Bowler        */ Theme::Art,
    /* 160 Mammatus               */ Theme::Weather,
    /* 161 Mandelbrot             */ Theme::Physics,
    /* 162 March of Progress      */ Theme::Biology,
    /* 163 Mars Rover             */ Theme::Physics,
    /* 164 Mary Poppins           */ Theme::Cinema,
    /* 165 Matrix Drop            */ Theme::Cinema,
    /* 166 Memento                */ Theme::Cinema,
    /* 167 Mendel                 */ Theme::Biology,
    /* 168 Mendeleev              */ Theme::Chemistry,
    /* 169 Mentos                 */ Theme::Chemistry,
    /* 170 Mitochondrial Eve      */ Theme::Biology,
    /* 171 MJO                    */ Theme::Weather,
    /* 172 Mjolnir                */ Theme::Myth,
    /* 173 Mobius                 */ Theme::Physics,
    /* 174 Mona Lisa              */ Theme::Art,
    /* 175 Monolith               */ Theme::Cinema,
    /* 176 Monsoon                */ Theme::Weather,
    /* 177 Monty Python           */ Theme::Cartoon,
    /* 178 Moon Flag              */ Theme::History,
    /* 179 Moon Phases            */ Theme::Physics,
    /* 180 Moon Rocket            */ Theme::Cinema,
    /* 181 Munch Scream           */ Theme::Art,
    /* 182 Mutation               */ Theme::Biology,
    /* 183 Muybridge              */ Theme::Cinema,
    /* 184 NaCl Lattice           */ Theme::Chemistry,
    /* 185 Napoleon               */ Theme::History,
    /* 186 Neo                    */ Theme::Cinema,
    /* 187 Neutron Star           */ Theme::Physics,
    /* 188 Newspaper              */ Theme::TerminalFx,
    /* 189 Newton                 */ Theme::History,
    /* 190 Newton Cradle          */ Theme::Physics,
    /* 191 Nosferatu              */ Theme::Cinema,
    /* 192 Olympic Torch          */ Theme::History,
    /* 193 Olympus Mons           */ Theme::Physics,
    /* 194 Opera Curtain          */ Theme::Music,
    /* 195 Oscar Statue           */ Theme::Cinema,
    /* 196 Out of Africa          */ Theme::Biology,
    /* 197 Ozone Hole             */ Theme::Weather,
    /* 198 Pac-Man                */ Theme::Cartoon,
    /* 199 Pac-Man Duel           */ Theme::Cartoon,
    /* 200 Pandora                */ Theme::Myth,
    /* 201 Pandora Foot           */ Theme::Myth,
    /* 202 Pangaea                */ Theme::Physics,
    /* 203 Parker Probe           */ Theme::Physics,
    /* 204 Parthenon              */ Theme::History,
    /* 205 Peacock                */ Theme::Biology,
    /* 206 Pegasus                */ Theme::Myth,
    /* 207 Pendulum Waves         */ Theme::Physics,
    /* 208 Peppered Moth          */ Theme::Biology,
    /* 209 Periodic Table         */ Theme::Chemistry,
    /* 210 pH Strip               */ Theme::Chemistry,
    /* 211 Phase Transition       */ Theme::Chemistry,
    /* 212 Phoenix                */ Theme::Myth,
    /* 213 Pi                     */ Theme::Physics,
    /* 214 Piano Keys             */ Theme::Music,
    /* 215 Pillars of Creation    */ Theme::Physics,
    /* 216 Pink Panther           */ Theme::Cartoon,
    /* 217 Pleasantville          */ Theme::Cinema,
    /* 218 Polar Vortex           */ Theme::Weather,
    /* 219 Pompeii                */ Theme::History,
    /* 220 Pride Rock             */ Theme::Cinema,
    /* 221 Psycho                 */ Theme::Cinema,
    /* 222 Pulp Briefcase         */ Theme::Cinema,
    /* 223 Pulp Fiction           */ Theme::Cinema,
    /* 224 Pulsar                 */ Theme::Physics,
    /* 225 Punctuated             */ Theme::Biology,
    /* 226 Pyramids               */ Theme::History,
    /* 227 Pythagoras             */ Theme::Physics,
    /* 228 Python Cut             */ Theme::Cartoon,
    /* 229 Python Wars            */ Theme::Cartoon,
    /* 230 Quetzalcoatl           */ Theme::Myth,
    /* 231 Ragnarok               */ Theme::Myth,
    /* 232 Red Balloon            */ Theme::Cinema,
    /* 233 Ring of Fire           */ Theme::Physics,
    /* 234 Riverdance             */ Theme::Music,
    /* 235 Rocky                  */ Theme::Cinema,
    /* 236 Rosebud                */ Theme::Cinema,
    /* 237 Rubik                  */ Theme::Physics,
    /* 238 Russian Dance          */ Theme::Music,
    /* 239 Sagittarius A          */ Theme::Physics,
    /* 240 Saharan Dust           */ Theme::Weather,
    /* 241 Saturn                 */ Theme::Physics,
    /* 242 Saturn Rings           */ Theme::Physics,
    /* 243 Schrodinger            */ Theme::Physics,
    /* 244 Sea Ice                */ Theme::Weather,
    /* 245 Selection              */ Theme::Biology,
    /* 246 Shawshank              */ Theme::Cinema,
    /* 247 Sheet Music            */ Theme::Music,
    /* 248 Shining                */ Theme::Cinema,
    /* 249 Shiver                 */ Theme::TerminalFx,
    /* 250 Sierpinski             */ Theme::Physics,
    /* 251 Silly Walk             */ Theme::Cartoon,
    /* 252 Singin'                */ Theme::Music,
    /* 253 Sistine                */ Theme::Art,
    /* 254 Skeleton Wave          */ Theme::TerminalFx,
    /* 255 Snow Tree              */ Theme::Weather,
    /* 256 Snowfall               */ Theme::Weather,
    /* 257 Soap Bubble            */ Theme::Chemistry,
    /* 258 Solar Eclipse          */ Theme::Physics,
    /* 259 Solar Flare            */ Theme::Physics,
    /* 260 Solar System           */ Theme::Physics,
    /* 261 Sound of Music         */ Theme::Music,
    /* 262 Spaghettify            */ Theme::Physics,
    /* 263 Spider                 */ Theme::TerminalFx,
    /* 264 Spiral                 */ Theme::TerminalFx,
    /* 265 Spirited Train         */ Theme::Cinema,
    /* 266 Sputnik                */ Theme::History,
    /* 267 Standing Wave          */ Theme::Physics,
    /* 268 Standoff               */ Theme::Cinema,
    /* 269 Star Gate              */ Theme::Cinema,
    /* 270 Star Wars              */ Theme::Cinema,
    /* 271 Stephenson             */ Theme::History,
    /* 272 Stingray               */ Theme::Weather,
    /* 273 Stonehenge             */ Theme::History,
    /* 274 Stradivarius           */ Theme::Music,
    /* 275 Strangelove            */ Theme::Cinema,
    /* 276 Submarine              */ Theme::Music,
    /* 277 Sun Dogs               */ Theme::Physics,
    /* 278 Sunspot Cycle          */ Theme::Physics,
    /* 279 Supercell              */ Theme::Weather,
    /* 280 Supernova              */ Theme::Physics,
    /* 281 Tatooine               */ Theme::Cinema,
    /* 282 Teardrop               */ Theme::TerminalFx,
    /* 283 Tears in Rain          */ Theme::Cinema,
    /* 284 Test Card              */ Theme::TerminalFx,
    /* 285 Thanos Snap            */ Theme::Cinema,
    /* 286 That's All Folks       */ Theme::Cartoon,
    /* 287 The Birds              */ Theme::Cinema,
    /* 288 The End                */ Theme::TerminalFx,
    /* 289 Thelma & Louise        */ Theme::Cinema,
    /* 290 Theremin               */ Theme::Music,
    /* 291 Thriller               */ Theme::Music,
    /* 292 Thunderstorm           */ Theme::Weather,
    /* 293 Titanic                */ Theme::Cinema,
    /* 294 Top Hat                */ Theme::Cartoon,
    /* 295 Tornado                */ Theme::Weather,
    /* 296 Tornado Duel           */ Theme::Weather,
    /* 297 Totoro                 */ Theme::Cinema,
    /* 298 Tracks                 */ Theme::Cinema,
    /* 299 Train                  */ Theme::Cinema,
    /* 300 Tree of Life           */ Theme::Biology,
    /* 301 Trojan Foot            */ Theme::Myth,
    /* 302 Trojan Horse           */ Theme::History,
    /* 303 Tron                   */ Theme::Cinema,
    /* 304 Trophy                 */ Theme::Cartoon,
    /* 305 Truman                 */ Theme::Cinema,
    /* 306 Tsunami                */ Theme::Weather,
    /* 307 Tunnel                 */ Theme::TerminalFx,
    /* 308 UFO                    */ Theme::Cinema,
    /* 309 Up                     */ Theme::Cinema,
    /* 310 Utopia                 */ Theme::TerminalFx,
    /* 311 Valkyrie Ride          */ Theme::Music,
    /* 312 Vertigo                */ Theme::Cinema,
    /* 313 Viking Longboat        */ Theme::History,
    /* 314 Vinyl Spin             */ Theme::Music,
    /* 315 Voyager                */ Theme::Physics,
    /* 316 Walker Cell            */ Theme::Weather,
    /* 317 Warhol Banana          */ Theme::Art,
    /* 318 Warp                   */ Theme::TerminalFx,
    /* 319 Wildfire Smoke         */ Theme::Weather,
    /* 320 William Tell           */ Theme::Myth,
    /* 321 Wizard of Oz           */ Theme::Cinema,
    /* 322 Word Reveal            */ Theme::TerminalFx,
    /* 323 Wormhole               */ Theme::Physics,
    /* 324 Wright Flyer           */ Theme::History,
    /* 325 Yggdrasil              */ Theme::Myth,
    /* 326 YMCA                   */ Theme::Music,
    /* 327 Yorick                 */ Theme::Cinema,
};
