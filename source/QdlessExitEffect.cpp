                              ...
                              const std::vector<char>* swedenMask)
{
  ...
  switch (e)
  {
    ...
    case 182: effectMuybridge(renderer, frame, subW, subH); break;
    case 183: effectNaClLattice(renderer, frame, subW, subH); break;
    case 184: effectNapoleon(renderer, frame, subW, subH); break;
    case 185: effectNeo(renderer, frame, subW, subH); break;
    case 186: effectNeutronStar(renderer, frame, subW, subH); break;
    case 187: effectNewspaper(renderer, frame, subW, subH); break;
    case 188: effectNewton(renderer, frame, subW, subH); break;
    case 189: effectNewtonCradle(renderer, frame, subW, subH); break;
    case 190: effectNosferatu(renderer, frame, subW, subH); break;
    case 191: effectOlympicTorch(renderer, frame, subW, subH); break;
    case 192: effectOlympusMons(renderer, frame, subW, subH); break;
    case 193: effectOperaCurtain(renderer, frame, subW, subH); break;
    case 194: effectOscarStatue(renderer, frame, subW, subH); break;
    case 195: effectOutOfAfrica(renderer, frame, subW, subH); break;
    case 196: effectOzoneHole(renderer, frame, subW, subH); break;
    case 197: effectPacman(renderer, frame, subW, subH); break;
    case 198: effectPacmanDuel(renderer, frame, subW, subH); break;
    case 199: effectPandora(renderer, frame, subW, subH); break;
    case 200: effectPandoraFoot(renderer, frame, subW, subH); break;
    case 201: effectPangaea(renderer, frame, subW, subH); break;
    case 202: effectParkerProbe(renderer, frame, subW, subH); break;
    case 203: effectParthenon(renderer, frame, subW, subH); break;
    case 204: effectPeacock(renderer, frame, subW, subH); break;
    case 205: effectPegasus(renderer, frame, subW, subH); break;
    case 206: effectPendulumWaves(renderer, frame, subW, subH); break;
    case 207: effectPepperedMoth(renderer, frame, subW, subH); break;
    case 208: effectPeriodicTable(renderer, frame, subW, subH); break;
    case 209: effectPhStrip(renderer, frame, subW, subH); break;
    case 210: effectPhaseTransition(renderer, frame, subW, subH); break;
    case 211: effectPhoenix(renderer, frame, subW, subH); break;
    case 212: effectPi(renderer, frame, subW, subH); break;
    case 213: effectPianoKeys(renderer, frame, subW, subH); break;
    case 214: effectPillarsOfCreation(renderer, frame, subW, subH); break;
    case 215: effectPinkPanther(renderer, frame, subW, subH); break;
    case 216: effectPleasantville(renderer, frame, subW, subH); break;
    case 217: effectPolarVortex(renderer, frame, subW, subH); break;
    case 218: effectPompeii(renderer, frame, subW, subH); break;
    case 219: effectPrideRock(renderer, frame, subW, subH); break;
    case 220: effectPsycho(renderer, frame, subW, subH); break;
    case 221: effectPulpBriefcase(renderer, frame, subW, subH); break;
    case 222: effectPulp(renderer, frame, subW, subH); break;
    case 223: effectPulsar(renderer, frame, subW, subH); break;
    case 224: effectPunctuated(renderer, frame, subW, subH); break;
    case 225: effectPyramids(renderer, frame, subW, subH); break;
    case 226: effectPythagoras(renderer, frame, subW, subH); break;
    case 227: effectPythonCut(renderer, frame, subW, subH); break;
    case 228: effectPythonWars(renderer, frame, subW, subH); break;
    case 229: effectQuetzalcoatl(renderer, frame, subW, subH); break;
    case 230: effectRagnarok(renderer, frame, subW, subH); break;
    case 231: effectRedBalloon(renderer, frame, subW, subH); break;
    case 232: effectRingOfFire(renderer, frame, subW, subH); break;
    case 233: effectRiverdance(renderer, frame, subW, subH); break;
    case 234: effectRocky(renderer, frame, subW, subH); break;
    case 235: effectRosebud(renderer, frame, subW, subH, rng); break;
    case 236: effectRubik(renderer, frame, subW, subH, rng); break;
    case 237: effectRussianDance(renderer, frame, subW, subH); break;
    case 238: effectSagittariusA(renderer, frame, subW, subH); break;
    case 239: effectSaharanDust(renderer, frame, subW, subH); break;
    case 240: effectSaturn(renderer, frame, subW, subH); break;
    case 241: effectSaturnRings(renderer, frame, subW, subH); break;
    case 242: effectSchrodinger(renderer, frame, subW, subH); break;
    case 243: effectSeaIce(renderer, frame, subW, subH); break;
    case 244: effectSelection(renderer, frame, subW, subH); break;
    case 245: effectShawshank(renderer, frame, subW, subH); break;
    case 246: effectSheetMusic(renderer, frame, subW, subH); break;
    case 247: effectShining(renderer, frame, subW, subH); break;
    case 248: effectShiver(renderer, frame, subW, subH, rng); break;
    case 249: effectSierpinski(renderer, frame, subW, subH); break;
    case 250: effectSillyWalk(renderer, frame, subW, subH); break;
    case 251: effectSinginRain(renderer, frame, subW, subH); break;
    case 252: effectSistine(renderer, frame, subW, subH); break;
    case 253: effectSkeletonWave(renderer, frame, subW, subH); break;
    case 254: effectSnowTree(renderer, frame, subW, subH); break;
    case 255: effectSnowflakes(renderer, frame, subW, subH, rng); break;
    case 256: effectSoapBubble(renderer, frame, subW, subH); break;
    case 257: effectSolarEclipse(renderer, frame, subW, subH); break;
    case 258: effectSolarFlare(renderer, frame, subW, subH); break;
    case 259: effectSolarSystem(renderer, frame, subW, subH, rng); break;
    case 260: effectSoundOfMusic(renderer, frame, subW, subH); break;
    case 261: effectSpaghettify(renderer, frame, subW, subH); break;
    case 262: effectSpider(renderer, frame, subW, subH); break;
    case 263: effectSpiral(renderer, frame, subW, subH); break;
    case 264: effectSpiritedTrain(renderer, frame, subW, subH); break;
    case 265: effectSputnik(renderer, frame, subW, subH); break;
    case 266: effectStandingWave(renderer, frame, subW, subH); break;
    case 267: effectStandoff(renderer, frame, subW, subH); break;
    case 268: effectStarGate(renderer, frame, subW, subH); break;
    case 269: effectStarWars(renderer, frame, subW, subH); break;
    case 270: effectStephenson(renderer, frame, subW, subH); break;
    case 271: effectStingray(renderer, frame, subW, subH); break;
    case 272: effectStonehenge(renderer, frame, subW, subH); break;
    case 273: effectStradivarius(renderer, frame, subW, subH); break;
    case 274: effectStrangelove(renderer, frame, subW, subH); break;
    case 275: effectSubmarine(renderer, frame, subW, subH, rng); break;
    case 276: effectSunDogs(renderer, frame, subW, subH); break;
    case 277: effectSunspotCycle(renderer, frame, subW, subH); break;
    case 278: effectSupercell(renderer, frame, subW, subH); break;
    case 279: effectSupernova(renderer, frame, subW, subH); break;
    case 280: effectTatooine(renderer, frame, subW, subH); break;
    case 281: effectTeardrop(renderer, frame, subW, subH); break;
    case 282: effectTearsInRain(renderer, frame, subW, subH, rng); break;
    case 283: effectTestCard(renderer, frame, subW, subH, rng); break;
    case 284: effectThanos(renderer, frame, subW, subH, rng); break;
    case 285: effectThatsAllFolks(renderer, frame, subW, subH); break;
    case 286: effectBirds(renderer, frame, subW, subH); break;
    case 287: effectTheEnd(renderer, frame, subW, subH, rng); break;
    case 288: effectThelma(renderer, frame, subW, subH); break;
    case 289: effectTheremin(renderer, frame, subW, subH); break;
    case 290: effectThriller(renderer, frame, subW, subH); break;
    case 291: effectThunderstorm(renderer, frame, subW, subH, rng); break;
    case 292: effectTitanic(renderer, frame, subW, subH); break;
    case 293: effectTopHat(renderer, frame, subW, subH); break;
    case 294: effectTornado(renderer, frame, subW, subH); break;
    case 295: effectTornadoDuel(renderer, frame, subW, subH); break;
    case 296: effectTotoro(renderer, frame, subW, subH); break;
    case 297: effectStandByMe(renderer, frame, subW, subH); break;
    case 298: effectTrain(renderer, frame, subW, subH); break;
    case 299: effectTreeOfLife(renderer, frame, subW, subH); break;
    case 300: effectTrojanFoot(renderer, frame, subW, subH); break;
    case 301: effectTrojanHorse(renderer, frame, subW, subH); break;
    case 302: effectTron(renderer, frame, subW, subH); break;
    case 303: effectTrophy(renderer, frame, subW, subH); break;
    case 304: effectTruman(renderer, frame, subW, subH); break;
    case 305: effectTsunami(renderer, frame, subW, subH); break;
    case 306: effectTunnel(renderer, frame, subW, subH); break;
    case 307: effectUFO(renderer, frame, subW, subH); break;
    case 308: effectUp(renderer, frame, subW, subH); break;
    case 309: effectUtopia(renderer, frame, subW, subH, rng, linesFrame, swedenMask); break;
    case 310: effectValkyrieRide(renderer, frame, subW, subH); break;
    case 311: effectVertigo(renderer, frame, subW, subH); break;
    case 312: effectVikingLongboat(renderer, frame, subW, subH); break;
    case 313: effectVinylSpin(renderer, frame, subW, subH); break;
    case 314: effectVoyager(renderer, frame, subW, subH); break;
    case 315: effectWalkerCell(renderer, frame, subW, subH); break;
    case 316: effectWarholBanana(renderer, frame, subW, subH); break;
    case 317: effectWarp(renderer, frame, subW, subH); break;
    case 318: effectWildfireSmoke(renderer, frame, subW, subH); break;
    case 319: effectWilliamTell(renderer, frame, subW, subH); break;
    case 320: effectOz(renderer, frame, subW, subH); break;
    case 321: effectWordReveal(renderer, frame, subW, subH, rng, words); break;
    case 322: effectWormhole(renderer, frame, subW, subH); break;
    case 323: effectWrightFlyer(renderer, frame, subW, subH); break;
    case 324: effectYggdrasil(renderer, frame, subW, subH); break;
    case 325: effectYMCA(renderer, frame, subW, subH); break;
    case 326: effectYorick(renderer, frame, subW, subH); break;
