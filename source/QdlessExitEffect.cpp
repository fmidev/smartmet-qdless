                              ...
                              const std::vector<char>* swedenMask)
{
  ...
  switch (e)
  {
    ...
    case 163: effectMarsRover(renderer, frame, subW, subH); break;
    case 164: effectMaryPoppins(renderer, frame, subW, subH); break;
    case 165: effectMatrix(renderer, frame, subW, subH, rng); break;
    case 166: effectMemento(renderer, frame, subW, subH); break;
    case 167: effectMendel(renderer, frame, subW, subH); break;
    case 168: effectMendeleev(renderer, frame, subW, subH); break;
    case 169: effectMentos(renderer, frame, subW, subH); break;
    case 170: effectMitochondrialEve(renderer, frame, subW, subH); break;
    case 171: effectMjo(renderer, frame, subW, subH); break;
    case 172: effectMjolnir(renderer, frame, subW, subH); break;
    case 173: effectMobius(renderer, frame, subW, subH); break;
    case 174: effectMonaLisa(renderer, frame, subW, subH); break;
    case 175: effectMonolith(renderer, frame, subW, subH); break;
    case 176: effectMonsoon(renderer, frame, subW, subH); break;
    case 177: effectMontyPython(renderer, frame, subW, subH); break;
    case 178: effectMoonFlag(renderer, frame, subW, subH); break;
    case 179: effectMoonPhases(renderer, frame, subW, subH); break;
    case 180: effectMoonRocket(renderer, frame, subW, subH); break;
    case 181: effectMunchScream(renderer, frame, subW, subH); break;
    case 182: effectMutation(renderer, frame, subW, subH); break;
    case 183: effectMuybridge(renderer, frame, subW, subH); break;
    case 184: effectNaClLattice(renderer, frame, subW, subH); break;
    case 185: effectNapoleon(renderer, frame, subW, subH); break;
    case 186: effectNeo(renderer, frame, subW, subH); break;
    case 187: effectNeutronStar(renderer, frame, subW, subH); break;
    case 188: effectNewspaper(renderer, frame, subW, subH); break;
    case 189: effectNewton(renderer, frame, subW, subH); break;
    case 190: effectNewtonCradle(renderer, frame, subW, subH); break;
    case 191: effectNosferatu(renderer, frame, subW, subH); break;
    case 192: effectOlympicTorch(renderer, frame, subW, subH); break;
    case 193: effectOlympusMons(renderer, frame, subW, subH); break;
    case 194: effectOperaCurtain(renderer, frame, subW, subH); break;
    case 195: effectOscarStatue(renderer, frame, subW, subH); break;
    case 196: effectOutOfAfrica(renderer, frame, subW, subH); break;
    case 197: effectOzoneHole(renderer, frame, subW, subH); break;
    case 198: effectPacman(renderer, frame, subW, subH); break;
    case 199: effectPacmanDuel(renderer, frame, subW, subH); break;
    case 200: effectPandora(renderer, frame, subW, subH); break;
    case 201: effectPandoraFoot(renderer, frame, subW, subH); break;
    case 202: effectPangaea(renderer, frame, subW, subH); break;
    case 203: effectParkerProbe(renderer, frame, subW, subH); break;
    case 204: effectParthenon(renderer, frame, subW, subH); break;
    case 205: effectPeacock(renderer, frame, subW, subH); break;
    case 206: effectPegasus(renderer, frame, subW, subH); break;
    case 207: effectPendulumWaves(renderer, frame, subW, subH); break;
    case 208: effectPepperedMoth(renderer, frame, subW, subH); break;
    case 209: effectPeriodicTable(renderer, frame, subW, subH); break;
    case 210: effectPhStrip(renderer, frame, subW, subH); break;
    case 211: effectPhaseTransition(renderer, frame, subW, subH); break;
    case 212: effectPhoenix(renderer, frame, subW, subH); break;
    case 213: effectPi(renderer, frame, subW, subH); break;
    case 214: effectPianoKeys(renderer, frame, subW, subH); break;
    case 215: effectPillarsOfCreation(renderer, frame, subW, subH); break;
    case 216: effectPinkPanther(renderer, frame, subW, subH); break;
    case 217: effectPleasantville(renderer, frame, subW, subH); break;
    case 218: effectPolarVortex(renderer, frame, subW, subH); break;
    case 219: effectPompeii(renderer, frame, subW, subH); break;
    case 220: effectPrideRock(renderer, frame, subW, subH); break;
    case 221: effectPsycho(renderer, frame, subW, subH); break;
    case 222: effectPulpBriefcase(renderer, frame, subW, subH); break;
    case 223: effectPulp(renderer, frame, subW, subH); break;
    case 224: effectPulsar(renderer, frame, subW, subH); break;
    case 225: effectPunctuated(renderer, frame, subW, subH); break;
    case 226: effectPyramids(renderer, frame, subW, subH); break;
    case 227: effectPythagoras(renderer, frame, subW, subH); break;
    case 228: effectPythonCut(renderer, frame, subW, subH); break;
    case 229: effectPythonWars(renderer, frame, subW, subH); break;
    case 230: effectQuetzalcoatl(renderer, frame, subW, subH); break;
    case 231: effectRagnarok(renderer, frame, subW, subH); break;
    case 232: effectRedBalloon(renderer, frame, subW, subH); break;
    case 233: effectRingOfFire(renderer, frame, subW, subH); break;
    case 234: effectRiverdance(renderer, frame, subW, subH); break;
    case 235: effectRocky(renderer, frame, subW, subH); break;
    case 236: effectRosebud(renderer, frame, subW, subH, rng); break;
    case 237: effectRubik(renderer, frame, subW, subH, rng); break;
    case 238: effectRussianDance(renderer, frame, subW, subH); break;
    case 239: effectSagittariusA(renderer, frame, subW, subH); break;
    case 240: effectSaharanDust(renderer, frame, subW, subH); break;
    case 241: effectSaturn(renderer, frame, subW, subH); break;
    case 242: effectSaturnRings(renderer, frame, subW, subH); break;
    case 243: effectSchrodinger(renderer, frame, subW, subH); break;
    case 244: effectSeaIce(renderer, frame, subW, subH); break;
    case 245: effectSelection(renderer, frame, subW, subH); break;
    case 246: effectShawshank(renderer, frame, subW, subH); break;
    case 247: effectSheetMusic(renderer, frame, subW, subH); break;
    case 248: effectShining(renderer, frame, subW, subH); break;
    case 249: effectShiver(renderer, frame, subW, subH, rng); break;
    case 250: effectSierpinski(renderer, frame, subW, subH); break;
    case 251: effectSillyWalk(renderer, frame, subW, subH); break;
    case 252: effectSinginRain(renderer, frame, subW, subH); break;
    case 253: effectSistine(renderer, frame, subW, subH); break;
    case 254: effectSkeletonWave(renderer, frame, subW, subH); break;
    case 255: effectSnowTree(renderer, frame, subW, subH); break;
    case 256: effectSnowflakes(renderer, frame, subW, subH, rng); break;
    case 257: effectSoapBubble(renderer, frame, subW, subH); break;
    case 258: effectSolarEclipse(renderer, frame, subW, subH); break;
    case 259: effectSolarFlare(renderer, frame, subW, subH); break;
    case 260: effectSolarSystem(renderer, frame, subW, subH, rng); break;
    case 261: effectSoundOfMusic(renderer, frame, subW, subH); break;
    case 262: effectSpaghettify(renderer, frame, subW, subH); break;
    case 263: effectSpider(renderer, frame, subW, subH); break;
    case 264: effectSpiral(renderer, frame, subW, subH); break;
    case 265: effectSpiritedTrain(renderer, frame, subW, subH); break;
    case 266: effectSputnik(renderer, frame, subW, subH); break;
    case 267: effectStandingWave(renderer, frame, subW, subH); break;
    case 268: effectStandoff(renderer, frame, subW, subH); break;
    case 269: effectStarGate(renderer, frame, subW, subH); break;
    case 270: effectStarWars(renderer, frame, subW, subH); break;
    case 271: effectStephenson(renderer, frame, subW, subH); break;
    case 272: effectStingray(renderer, frame, subW, subH); break;
    case 273: effectStonehenge(renderer, frame, subW, subH); break;
    case 274: effectStradivarius(renderer, frame, subW, subH); break;
    case 275: effectStrangelove(renderer, frame, subW, subH); break;
    case 276: effectSubmarine(renderer, frame, subW, subH, rng); break;
    case 277: effectSunDogs(renderer, frame, subW, subH); break;
    case 278: effectSunspotCycle(renderer, frame, subW, subH); break;
    case 279: effectSupercell(renderer, frame, subW, subH); break;
    case 280: effectSupernova(renderer, frame, subW, subH); break;
    case 281: effectTatooine(renderer, frame, subW, subH); break;
    case 282: effectTeardrop(renderer, frame, subW, subH); break;
    case 283: effectTearsInRain(renderer, frame, subW, subH, rng); break;
    case 284: effectTestCard(renderer, frame, subW, subH, rng); break;
    case 285: effectThanos(renderer, frame, subW, subH, rng); break;
    case 286: effectThatsAllFolks(renderer, frame, subW, subH); break;
    case 287: effectBirds(renderer, frame, subW, subH); break;
    case 288: effectTheEnd(renderer, frame, subW, subH, rng); break;
    case 289: effectThelma(renderer, frame, subW, subH); break;
    case 290: effectTheremin(renderer, frame, subW, subH); break;
    case 291: effectThriller(renderer, frame, subW, subH); break;
    case 292: effectThunderstorm(renderer, frame, subW, subH, rng); break;
    case 293: effectTitanic(renderer, frame, subW, subH); break;
    case 294: effectTopHat(renderer, frame, subW, subH); break;
    case 295: effectTornado(renderer, frame, subW, subH); break;
    case 296: effectTornadoDuel(renderer, frame, subW, subH); break;
    case 297: effectTotoro(renderer, frame, subW, subH); break;
    case 298: effectStandByMe(renderer, frame, subW, subH); break;
    case 299: effectTrain(renderer, frame, subW, subH); break;
    case 300: effectTreeOfLife(renderer, frame, subW, subH); break;
    case 301: effectTrojanFoot(renderer, frame, subW, subH); break;
    case 302: effectTrojanHorse(renderer, frame, subW, subH); break;
    case 303: effectTron(renderer, frame, subW, subH); break;
    case 304: effectTrophy(renderer, frame, subW, subH); break;
    case 305: effectTruman(renderer, frame, subW, subH); break;
    case 306: effectTsunami(renderer, frame, subW, subH); break;
    case 307: effectTunnel(renderer, frame, subW, subH); break;
    case 308: effectUFO(renderer, frame, subW, subH); break;
    case 309: effectUp(renderer, frame, subW, subH); break;
    case 310: effectUtopia(renderer, frame, subW, subH, rng, linesFrame, swedenMask); break;
    case 311: effectValkyrieRide(renderer, frame, subW, subH); break;
    case 312: effectVertigo(renderer, frame, subW, subH); break;
    case 313: effectVikingLongboat(renderer, frame, subW, subH); break;
    case 314: effectVinylSpin(renderer, frame, subW, subH); break;
    case 315: effectVoyager(renderer, frame, subW, subH); break;
    case 316: effectWalkerCell(renderer, frame, subW, subH); break;
    case 317: effectWarholBanana(renderer, frame, subW, subH); break;
    case 318: effectWarp(renderer, frame, subW, subH); break;
    case 319: effectWildfireSmoke(renderer, frame, subW, subH); break;
    case 320: effectWilliamTell(renderer, frame, subW, subH); break;
    case 321: effectOz(renderer, frame, subW, subH); break;
    case 322: effectWordReveal(renderer, frame, subW, subH, rng, words); break;
    case 323: effectWormhole(renderer, frame, subW, subH); break;
    case 324: effectWrightFlyer(renderer, frame, subW, subH); break;
    case 325: effectYggdrasil(renderer, frame, subW, subH); break;
    case 326: effectYMCA(renderer, frame, subW, subH); break;
    case 327: effectYorick(renderer, frame, subW, subH); break;
